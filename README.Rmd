...
You can install the development version of RSQLite.toolkit from [GitHub](https://github.com/) with:
...
This basic example shows you how to use the core functions of the package
to load some data in different tables in a test database:
